...
| `CHECK_GLARE`.                      | :heavy_minus_sign:  | `boolean`             | true, false     | Indicate whether the RDT requires to check glare in the result window. If the result window has reflective material, we recommend `CHECK_GLARE` to be 'true'. |

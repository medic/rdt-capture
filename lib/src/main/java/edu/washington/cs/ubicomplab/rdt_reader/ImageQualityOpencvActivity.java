...
public class ImageQualityOpencvActivity extends AppCompatActivity implements CvCameraViewListener2, SettingDialogFragment.SettingDialogListener, View.OnClickListener {
                ...
                if (isCorrectPosSize[0] && isCorrectPosSize[1] && isCorrectPosSize[2] && !isBlur && !isOverExposed && !isUnderExposed) {
                    ...
                    if (mCaptureProgressBar.getProgress() >= CAPTURE_COUNT) {
                        ...
                        if(isExternalIntent()) {
                            ...
                            Intent intent = new Intent(ImageQualityOpencvActivity.this, ImageResultActivity.class);
